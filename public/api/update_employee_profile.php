...
if (!isset($_SESSION['user_id']) || ($_SESSION['user_role'] ?? '') !== 'employee') {
    ...
    echo json_encode(['success' => false, 'message' => 'Unauthorized - Employee access required']);
    exit;
}
...
try {
    ...
    $stmt->execute([$firstName, $lastName, $fullName, $email, $phone ?: null, $userId]);
    ...
    error_log('update_employee_profile API error: ' . $e->getMessage());
