...
?>
  <div class="header-left" style="display: flex; align-items: center; gap: 15px;">
    ...
    <span style="font-size: 14px; color: rgba(255,255,255,0.85);">Furniture ERP &nbsp;<strong style="color:white;">Messages</strong></span>
  </div>
...
<div class="main-content">
  ...
  <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;margin-bottom:24px;">
    <div>
      <h1 style="margin:0 0 4px;font-size:22px;color:#2C3E50;"><i class="fas fa-envelope" style="color:#D4AC0D;margin-right:8px;"></i>Messages</h1>
      <p style="margin:0;font-size:13px;color:#95A5A6;">Communicate with your manager or assigned employee</p>
    </div>
    <button class="msg-btn-primary" style="background:linear-gradient(135deg,#7D6608,#D4AC0D);" onclick="openCompose()">
...
<div class="msg-modal" id="composeModal">
  <div class="msg-modal-box">
    <div class="msg-modal-head" style="background:linear-gradient(135deg,#7D6608,#D4AC0D);">
    ...
    <div class="msg-modal-foot">
      ...
      <button class="msg-btn-primary" style="background:linear-gradient(135deg,#7D6608,#D4AC0D);" onclick="sendMessage()">
...
<div class="msg-modal" id="viewModal">
  <div class="msg-modal-box" style="max-width:620px;">
    ...
    <div class="msg-modal-foot">
      ...
      <button class="msg-btn-primary" id="v_reply_btn" style="display:none;background:linear-gradient(135deg,#7D6608,#D4AC0D);" onclick="replyFromView()">
...
function renderTab(tab){
  ...
  const rows=msgs.map(m=>{
    ...
    return `<tr id="row-${m.id}" class="${isUnread?'unread-row':''}">
      <td><div style="display:flex;align-items:center;gap:8px;"><div class="msg-avatar" style="background:linear-gradient(135deg,#7D6608,#D4AC0D);">${(m.sender_name||m.receiver_name||'?')[0].toUpperCase()}</div><div>${who}</div></div></td>
