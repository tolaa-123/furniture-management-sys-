...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action']??'') === 'mark_all') {
    ...
    header('Location: '.BASE_URL.'/public/employee/notifications'); exit();
}
...
.notif-item:hover{background:#f8f9fa;}.notif-item.unread{background:#f0f8ff;border-left:3px solid #27ae60;}.notif-item.unread .notif-title{font-weight:700;}
...
<?php include_once __DIR__ . '/../../includes/employee_header.php'; ?>
